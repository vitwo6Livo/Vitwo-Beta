...
class SD_SO_PendingJobs_DetailsPage extends StatefulWidget {
  const SD_SO_PendingJobs_DetailsPage({super.key});

  @override
  State<SD_SO_PendingJobs_DetailsPage> createState() => _SD_SO_PendingJobs_DetailsPageState();
}

class _SD_SO_PendingJobs_DetailsPageState extends State<SD_SO_PendingJobs_DetailsPage> {
  @override
