...
class sd_Quotation_Closed extends StatefulWidget {
  const sd_Quotation_Closed({super.key});

  @override
  State<sd_Quotation_Closed> createState() => _sd_Quotation_ClosedState();
}

class _sd_Quotation_ClosedState extends State<sd_Quotation_Closed> {
