...
import 'package:vitwo_beta/src/Menu/Sales_Distribution/screens/Invoicing/detailsPage/IV_Overview.dart';
import 'package:vitwo_beta/src/constants/colors.dart';

class IV_detailsScreen extends StatefulWidget {
  final List<Map<String, dynamic>> items;
  const IV_detailsScreen(this.items, {super.key});

  @override
  State<IV_detailsScreen> createState() => _IV_detailsScreenState();
}

class _IV_detailsScreenState extends State<IV_detailsScreen> {
  @override
